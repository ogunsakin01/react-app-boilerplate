...
describe('scripts/generate.mjs', () => {
  ...
  it('creates a page with Vike page files and Playwright spec', () => {
    ...
    expect(existsSync(join(tmp, 'pages', 'dashboard', '+Page.tsx'))).toBe(true);
    expect(existsSync(join(tmp, 'pages', 'dashboard', '+title.ts'))).toBe(true);
